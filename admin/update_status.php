...
session_start();
    ...
    $run2 = mysqli_query($con,"insert into trips (stdid,date,pickup_time) values ('$stdid','$date','$time')");
    ...
    // header("location:delivary.php");
        ...
        $run3 = mysqli_query($con,"update delivary set ststus=1 where tripid='{$run1['tripid']}'");
        // header("location:delivary.php");
    }
?>